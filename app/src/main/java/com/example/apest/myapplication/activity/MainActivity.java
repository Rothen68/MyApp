...
import com.example.apest.myapplication.service.SQLDataService;
...
public class MainActivity extends AppCompatActivity implements MasterFragment.OnMasterFragmentInteractionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notiBuilder.setSmallIcon(R.mipmap.ic_launcher)
                .setTicker("Hello").setWhen(System.currentTimeMillis()).setAutoCancel(true)
                .setContentText("Hello you").setContentTitle("Hello")
    ...
    public DataService getFragmentDataSource() {
        if(dataSource == null)
        {
            dataSource = new SQLDataService(this);
        }
